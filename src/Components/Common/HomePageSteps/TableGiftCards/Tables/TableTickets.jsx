  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Grid sx={{ width: { xs: '100%', sm: '60%', md: '50%', lg: '30%' }, my: '15px' }}>
        <TextField
          size="small"
          placeholder="جستجو تیکت مورد نظر"
          value={searchText}
                      ...
                      <TableCell align="center" sx={{
                        ...
                        {e?.type === "status" && (
                          <Grid sx={{ display: 'flex', justifyContent: 'center' }}>
                            <StatusButton {...e} variant="contained" color={e?.text === 'close' ? 'error' : e?.text === 'open' ? 'success' : 'primary'}>                            {/* error or success or '' */}
                              {e?.text}
                            </StatusButton>
                          </Grid>
                        )}
                        {e?.type === "btn" && (
                          <>
                            <Grid sx={{ display: 'flex', justifyContent: 'center' }}>
                              ...
                              <Link href={`/panel/admin/Tickets/${row?.id}`} style={{ display: 'flex', alignItems: 'center', color: '#1C49F1' }}>
