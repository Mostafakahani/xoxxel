...
import GiftCardsItemForm from "Components/Common/HomePageSteps/GiftCardsItem/GiftCardsItemForm";
import GiftCardsItemList from "Components/Common/HomePageSteps/GiftCardsItem/GiftCardsItemList";
        ...
        const fetchData = async () => {
            ...
            try {
                const responseLevels = await axios.get(
                    `${ServerURL.url}/admin/sliders/giftcart/item/list?page=${page}&perPage=${perPage}`,
                    config
                );
    ...
    const handleSubmit = async () => {
        ...
        if (!isDuplicate) {
            ...
            try {
                ...
                const responseSend = await axios.post(`${ServerURL.url}/admin/sliders/giftcart/item/create`, dataSend, config);
                setSelectedFileItem([]);
                setInput1('')
                setRowsTemp([])
                setCount(count + 1)
