...
import HandleTableCategoryTopUpTopGames from "Components/Common/HomePageSteps/TableGiftCards/HandleTables/HandleTableCategoryTopUpTopGames";
import { useState } from "react";
const TableCategoryTopUpTopGamesPage = () => {
            ...
            <Grid>
                <Grid md={6}>
                    ...
                    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
                        <DialogContent>
                            <HandleTableCategoryTopUpTopGames />
                        </DialogContent>
                        <Grid sx={{ m: '20px' }}>
...
export default TableCategoryTopUpTopGamesPage;