                          ...
                          {e?.type === "btn" && (
                            <>
                              ...
                              <Button startIcon={<EyesIcon />} sx={{ backgroundColor: '#1C49F11A', color: '#1C49F1', borderRadius: "5px" }}>
                                ...
                                <Link href={`/panel/admin/Xp/${row?.id}`} style={{ display: 'flex', alignItems: 'center', color: '#1C49F1' }}>
                                  <Button disableElevation startIcon={<EyesIcon />} variant="text" color="primary" sx={{
