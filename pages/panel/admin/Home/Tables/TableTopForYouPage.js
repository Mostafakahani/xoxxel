...
const TableTopForYouPage = () => {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${ServerURL.url}/admin/sliders/top-up/for-you/create`, data, config);
        ...
        <>
            <AccountLayout>
                <Grid container>
                    <Grid item container >
                        <Grid item container>
                            <HandleTables labelTable={'Category For You'} getLinkTable={'/admin/sliders/top-up/for-you/list'} setSelectedId={setSelectedId} />
                        </Grid>
                    </Grid>
...
export default TableTopForYouPage;