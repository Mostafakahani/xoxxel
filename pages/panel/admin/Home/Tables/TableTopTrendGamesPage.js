...
const TableTopTrendGamesPage = () => {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${ServerURL.url}/admin/sliders/top-up/trend-game/create`, data, config);
        ...
        <>
            <AccountLayout>
                <Grid container>
                    <Grid item container >
                        <Grid item container>
                            <HandleTables labelTable={'Category Trending Games'} getLinkTable={'/admin/sliders/top-up/trend-game/list'} setSelectedId={setSelectedId} />
                        </Grid>
                    </Grid>
...
export default TableTopTrendGamesPage;